package com.socialengineaddons.messenger.settings;
...
import com.socialengineaddons.messenger.settings.adapter.SettingsListAdapter;
import com.socialengineaddons.messenger.settings.data_model.Settings;
import com.socialengineaddons.messenger.ui.SimpleDividerItemDecoration;
import com.socialengineaddons.messenger.user.BlockedContactsActivity;
    ...
    private void getUserSettings() {
        ...
        usersDb.child(self).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final int notificationsEnabled = dataSnapshot.hasChild("notification")
                        ? dataSnapshot.child("notification").getValue(Integer.class) : 0;
                onlineStatus = dataSnapshot.hasChild("isOnline")
                        ? dataSnapshot.child("isOnline").getValue(Integer.class) : 0;
                visibility = dataSnapshot.hasChild("visibility")
                        ? dataSnapshot.child("visibility").getValue(Integer.class) : 0;
                String language = dataSnapshot.hasChild("language")
                        ? dataSnapshot.child("language").getValue(String.class) : null;
