...
public class ConversationMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int VIEW_TYPE_MESSAGE_THIS_USER_FIRST = 11;
    ...
    private static final int VIEW_PROG_BAR = 10;
    ...
    public ConversationMessageAdapter(Context context, String user, int typeOfChat, LayoutInflater inflater,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_MESSAGE_THIS_USER_FIRST:
                messageView = (ConversationMessageView) inflater.inflate(R.layout.conversation_message_item_sender_view, parent, false);
                messageView.findViewById(R.id.sender_message_divider).setVisibility(View.VISIBLE);
                break;
            ...
            case VIEW_TYPE_MESSAGE_OTHER_USER_NAME:
                ...
                if (typeOfChat == 0) {
                    messageView.findViewById(R.id.user_name).setVisibility(View.GONE);
                    messageView.findViewById(R.id.receive_message_divider).setVisibility(View.VISIBLE);
                }
                break;
        ...
        if(position == 0){
            ...
            if (!concatDate1.equals(concatDate2)) {
                ...
                try{
                    ...
                    return ownerId1.equals(self) ? !ownerId1.equals(ownerId2) ? VIEW_TYPE_MESSAGE_THIS_USER_FIRST : VIEW_TYPE_MESSAGE_THIS_USER
                    ...
                    return chat.get(position).getOwnerId().equals(self) ? !self.equals(chat.get(position-1).getOwnerId()) ? VIEW_TYPE_MESSAGE_THIS_USER_FIRST : VIEW_TYPE_MESSAGE_THIS_USER :
