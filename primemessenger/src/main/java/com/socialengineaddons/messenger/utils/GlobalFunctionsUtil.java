...
public class GlobalFunctionsUtil {
    ...
    /**
     * Method to hide keyboard in dialog edit text.
     * @param context Context of calling class.
     * @param view View in which keyboard need to be hidden.
     */
    public static void hideKeyboardInDialog(Context context, View view) {
        if (view != null) {
