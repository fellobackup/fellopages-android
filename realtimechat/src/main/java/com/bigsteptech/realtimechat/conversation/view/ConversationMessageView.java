        ...
        switch (message.getAttachmentType()){
            ...
            case "image":
                ...
                if(message.getTemporaryPath() != null && !message.getTemporaryPath().isEmpty()){
                    ...
                    Log.d(ConversationMessageView.class.getSimpleName(), "1");
                    ...
                    Log.d(ConversationMessageView.class.getSimpleName(), "2");
                    progressBar.setVisibility(VISIBLE);
                    ...
                    Log.d(ConversationMessageView.class.getSimpleName(), "3");
...
//                                mediaPlayer.release();
        ...
        if(userImage != null){
            int widthHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.user_image_width);
            Picasso.with(mContext)
