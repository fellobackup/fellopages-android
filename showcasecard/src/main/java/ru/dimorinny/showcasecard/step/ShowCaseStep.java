...
public class ShowCaseStep {
    ...
    /**
     * Radius of show case active view
     */
    ...
    public ShowCaseStep(@NonNull View viewToShowCase, String message) {
        this.position = new ViewPosition(viewToShowCase);
     ...
     * @param viewToShowCase showcase will point to this view
     * @param message        message to show
     * @param radius         radius of show case view
     */
    public ShowCaseStep(@NonNull View viewToShowCase, String message, float radius) {
        this.position = new ViewPosition(viewToShowCase);
        this.message = message;
        this.radius = radius;
    }
     ...
     * @param radius   radius of show case view
     */
    public ShowCaseStep(ShowCasePosition position, String message, float radius) {
        this.position = position;
        this.message = message;
        this.radius = radius;
    }
