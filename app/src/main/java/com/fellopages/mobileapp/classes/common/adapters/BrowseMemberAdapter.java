...
public class BrowseMemberAdapter extends ArrayAdapter<BrowseListItems> implements OnMenuClickResponseListener {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (mRootView == null) {
            ...
            listItemHolder.mAge = mRootView.findViewById(R.id.age);
            listItemHolder.mLocation = mRootView.findViewById(R.id.location);
            listItemHolder.mMutualFriendCount = mRootView.findViewById(R.id.mutualFriendCount);
            listItemHolder.mAgeIcon = mRootView.findViewById(R.id.age_icon);
            listItemHolder.mLocationIcon = mRootView.findViewById(R.id.location_icon);
            listItemHolder.mMutualFriendIcon = mRootView.findViewById(R.id.mutualFriendIcon);
            listItemHolder.mMemberOnlineIcon = mRootView.findViewById(R.id.online_icon);
