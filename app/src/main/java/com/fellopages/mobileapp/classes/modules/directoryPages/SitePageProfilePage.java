...
public class SitePageProfilePage extends AppCompatActivity implements View.OnClickListener,
    ...
    private String menuName, profileImageUrl, coverImageUrl;
    ...
    private void loadViewPageData(JSONObject bodyJsonObject) {
        ...
        if (bodyJsonObject != null && bodyJsonObject.length() != 0) {
            try {
                ...
                page_id = bodyJsonObject.optInt("page_id");
        ...
        switch (resultCode) {
            ...
            case ConstantVariables.CREATE_REQUEST_CODE:
                ...
                if (requestCode == ConstantVariables.PAGE_EDIT_CODE
                    ...
                    new UploadFileToServerUtils(SitePageProfilePage.this, postUrl, resultList, this).execute();
                }
                break;
